...
const WebsiteMaintenance = () => (
  <div className="min-h-screen bg-background">
    ...
    <ServicePageLayout
      ...
      description="Keep your website secure, fast, and up-to-date with our comprehensive maintenance plans. We handle the technical details so you can focus on growing your business."
      benefits={[
