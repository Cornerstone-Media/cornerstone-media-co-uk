...
const PPC = () => (
  <div className="min-h-screen bg-background">
    ...
    <ServicePageLayout
      ...
      description="Maximise your advertising budget with expertly managed PPC campaigns that deliver measurable results across Google Ads, Bing, and social platforms."
      benefits={[
        "Targeted campaigns that reach your ideal customers at the right moment",
      ...
      topics={[
        { title: "Google Ads Management", description: "Search, display, shopping, and video campaigns managed by certified Google Ads specialists for maximum visibility and conversions." },
